...
var V = defineComponent({ name: "IconView", props: { height: { type: [String, Number], default: "16" }, width: { type: [String, Number], default: "16" }, color: { type: String, default: "black" }, customClass: { type: String, required: false, default: "" } }, setup: function() {
  return {};
} });
V.render = function(e2, t2, a2, n2, r2, i) {
...
}, V.__file = "src/components/iconview/IconView.vue";
var N = function(e2) {
...
var J = defineComponent({ name: "DateInput", components: { IconView: V }, props: { selectedDate: { type: [Date, String] }, resetTypedDate: { type: [Date] }, format: { type: [String, Function] }, translation: { type: Object }, inline: { type: Boolean }, id: { type: String }, name: { type: String }, openDate: { type: Date }, placeholder: { type: String }, inputClass: { type: String }, clearButton: { type: Boolean }, clearButtonIcon: { type: String }, calendarButton: { type: Boolean }, calendarButtonIcon: { type: String }, calendarButtonIconContent: { type: String }, disabled: { type: Boolean }, required: { type: Boolean }, typeable: { type: Boolean }, addBootstrapClass: { type: Boolean }, useUtc: { type: Boolean }, minimumView: { type: String, default: "day" }, maximumView: { type: String, default: "year" }, hideInput: { type: Boolean, default: true }, fullMonthName: { type: Boolean, default: false }, iconColor: { default: "black", type: String }, iconHeight: { default: 16, type: [String, Number] }, iconWidth: { default: 16, type: [String, Number] }, theme: { default: "green", type: String } }, emits: ["show-calendar", "typed-date", "clear-date", "close-calendar"], setup: function(t2, r2) {
  var i = r2.emit, o = ref(), l = ref(null), s = computed(function() {
    ...
    if (o.value)
      return o.value;
    var a2 = R(t2.selectedDate), n2 = "function" == typeof t2.format ? t2.format(a2) : function(e2, t3, a3) {
      var n3 = N(e2), r4 = T(e2) + 1, i3 = B(e2);
      return t3.replace(/dd/, "0".concat(i3).slice(-2)).replace(/d/, i3).replace(/yyyy/, n3).replace(/yy/, String(n3).slice(2)).replace(/MMMM/, H(T(e2), a3.months)).replace(/MMM/, I(T(e2), a3.monthsAbbr)).replace(/MM/, "0".concat(r4).slice(-2)).replace(/M(?!a|ä|e)/, r4.toString()).replace(/su/, function(e3) {
        switch (e3) {
          case 1:
          case 21:
          case 31:
      ...
      }(B(e2))).replace(/D(?!e|é|i)/, z(e2, a3.days));
    }(a2, t2.format, t2.translation);
    if (t2.minimumView === t2.maximumView) {
      var r3 = e(n2.split(" "), 3), i2 = r3[1], l2 = r3[2];
      if ("month" === t2.maximumView) {
        if (t2.fullMonthName) {
          var s2, d2, u = null === (s2 = t2.translation) || void 0 === s2 ? void 0 : s2.monthsAbbr.indexOf(i2);
          return null === (d2 = t2.translation) || void 0 === d2 ? void 0 : d2.months[u];
        }
        n2 = i2;
      } else
  ...
  return watch(function() {
    ...
    t2.typeable && Number.isNaN(Date.parse(l.value.value)) && (i("clear-date"), l.value.value = null, o.value = ""), i("close-calendar", true);
  }, inputRef: l };
} });
var U = { key: 0 };
...
J.render = function(e2, t2, a2, n2, r2, i) {
  ...
  return openBlock(), createBlock("div", { class: [e2.addBootstrapClass ? "input-group" : ""] }, [createCommentVNode(" Calendar Button "), e2.calendarButton ? (openBlock(), createBlock("span", { key: 0, class: ["vuejs3-datepicker__calendar-button", { "input-group-prepend": e2.addBootstrapClass }], onClick: t2[1] || (t2[1] = function() {
    ...
    return e2.clearDate();
  }) }, [createVNode("span", { class: { "input-group-text": e2.addBootstrapClass } }, [createVNode("i", { class: e2.clearButtonIcon }, [e2.clearButtonIcon ? createCommentVNode("v-if", true) : (openBlock(), createBlock("span", K, "\xD7"))], 2)], 2)], 2)) : createCommentVNode("v-if", true), renderSlot(e2.$slots, "belowDate")], 2);
}, J.__file = "src/components/datepicker/DateInput.vue";
var Q = defineComponent({ name: "PickerDay", props: { showDayView: { type: Boolean }, selectedDate: { type: [String, Date], default: new Date() }, pageDate: { type: Date, default: new Date() }, pageTimestamp: { type: Number }, fullMonthName: { type: Boolean }, allowedToShowView: { type: Function }, dayCellContent: { type: Function, default: function(e2) {
  return e2.date;
  ...
  function n2(t3) {
    var n3 = e2.pageDate;
    A(n3, T(n3) + t3), a2("changed-month", n3);
  }
  function r2() {
    ...
    if (!t3 || !t3.to)
      return false;
    var a3 = e2.pageDate;
    return T(t3.to) >= T(a3) && N(t3.to) >= N(a3);
  }
  function i() {
    var t3 = e2.disabledDates;
    if (!t3 || !t3.from)
      return false;
    var a3 = e2.pageDate;
    return T(t3.from) <= T(a3) && N(t3.from) <= N(a3);
  }
  function o(t3) {
    var a3 = R(e2.selectedDate);
  ...
  function u(t3) {
    var a3 = e2.highlighted;
    return !!a3 && (d(t3) && a3.from instanceof Date && N(a3.from) === N(t3) && T(a3.from) === T(t3) && B(a3.from) === B(t3));
  }
  function c(t3) {
    var a3 = e2.highlighted;
    return !!a3 && (d(t3) && a3.to instanceof Date && N(a3.to) === N(t3) && T(a3.to) === T(t3) && B(a3.to) === B(t3));
  }
  var m = computed(function() {
    ...
    for (var t3, a3, n3 = e2.pageDate, r3 = [], i2 = e2.useUtc ? new Date(Date.UTC(n3.getUTCFullYear(), n3.getUTCMonth(), 1)) : new Date(n3.getFullYear(), n3.getMonth(), 1, n3.getHours(), n3.getMinutes()), s2 = (t3 = N(i2), a3 = T(i2), /8|3|5|10/.test(a3) ? 30 : 1 === a3 ? (t3 % 4 || !(t3 % 100)) && t3 % 400 ? 28 : 29 : 31), p = 0; p < s2; p += 1)
      r3.push({ date: B(i2), timestamp: i2.getTime(), isSelected: o(i2), isDisabled: l(i2), isHighlighted: d(i2), isHighlightStart: u(i2), isHighlightEnd: c(i2), isToday: P(i2, new Date()), isWeekend: 0 === O(i2) || 6 === O(i2), isSaturday: 6 === O(i2), isSunday: 0 === O(i2) }), F(i2, B(i2) + 1);
    return r3;
  }), y = computed(function() {
    ...
    return H(T(e2.pageDate), t3);
  }), g = computed(function() {
    var t3 = e2.translation && e2.translation.yearSuffix;
    return "".concat(N(e2.pageDate)).concat(t3);
  });
  ...
  }), days: h, currMonthName: y, currYearName: g, isLeftNavDisabled: computed(function() {
  ...
  }, monthName: v, getDayName: computed(function() {
    var t3 = R(e2.selectedDate);
    return e2.selectedDate ? z(t3, e2.translation && e2.translation.daysNames) : null;
...
var te = defineComponent({ name: "PickerMonth", props: { showMonthView: { type: Boolean }, selectedDate: { type: [String, Date], default: new Date() }, pageDate: { type: Date, default: new Date() }, pageTimestamp: { type: Number }, disabledDates: { type: Object }, calendarClass: { type: [String, Object, Array] }, calendarStyle: { type: Object }, translation: { type: Object }, isRtl: { type: Boolean }, allowedToShowView: { type: Function }, useUtc: { type: Boolean }, fullMonthName: { type: Boolean }, minimumView: { type: String, default: "day" }, maximumView: { type: String, default: "year" }, theme: { default: "green", type: String } }, setup: function(e2, t2) {
  ...
  function n2(t3) {
    var n3 = e2.pageDate;
    Y(n3, N(n3) + t3), a2("changed-year", n3);
  }
  function r2() {
    var t3 = e2.disabledDates;
    return !(!t3 || !t3.to) && N(t3.to) >= N(e2.pageDate);
  }
  function i() {
    var t3 = e2.disabledDates;
    return !(!t3 || !t3.from) && N(t3.from) <= N(e2.pageDate);
  }
  function o(t3) {
    var a3 = R(e2.selectedDate);
    return a3 && N(a3) === N(t3) && T(a3) === T(t3);
  }
  function l(t3) {
    var a3 = false, n3 = e2.disabledDates;
    return !!n3 && (void 0 !== n3 && (void 0 !== n3.to && n3.to && (T(t3) < T(n3.to) && N(t3) <= N(n3.to) || N(t3) < N(n3.to)) && (a3 = true), void 0 !== n3.from && n3.from && (T(t3) > T(n3.from) && N(t3) >= N(n3.from) || N(t3) > N(n3.from)) && (a3 = true), "function" == typeof n3.customPredictor && n3.customPredictor(t3) && (a3 = true), a3));
  }
  var s = computed(function() {
    for (var t3 = e2.pageDate, a3 = [], n3 = e2.useUtc ? new Date(Date.UTC(t3.getUTCFullYear(), 0, t3.getUTCDate())) : new Date(t3.getFullYear(), 0, t3.getDate(), t3.getHours(), t3.getMinutes()), r3 = 0; r3 < 12; r3 += 1)
      a3.push({ month: H(r3, e2.translation && e2.translation.months), timestamp: n3.getTime(), isSelected: o(n3), isDisabled: l(n3) }), A(n3, T(n3) + 1);
    return a3;
  }), d = computed(function() {
    var t3 = e2.translation && e2.translation.yearSuffix;
    return "".concat(N(e2.pageDate)).concat(t3);
...
var ie = defineComponent({ name: "PickerYear", props: { showYearView: { type: Boolean }, selectedDate: { type: [String, Date], default: new Date() }, pageDate: { type: Date, default: new Date() }, pageTimestamp: { type: Number }, disabledDates: { type: Object }, highlighted: { type: Object }, calendarClass: { type: [String, Object, Array] }, calendarStyle: { type: Object }, translation: { type: Object }, isRtl: { type: Boolean }, allowedToShowView: { type: Function }, useUtc: { type: Boolean }, fullMonthName: { type: Boolean }, minimumView: { type: String, default: "day" }, maximumView: { type: String, default: "year" }, theme: { default: "green", type: String } }, emits: ["select-year", "changed-decade"], setup: function(e2, t2) {
  var a2 = t2.emit;
  function n2(t3) {
    var n3 = e2.pageDate;
    Y(n3, N(n3) + t3), a2("changed-decade", n3);
  }
  function r2() {
    var t3 = e2.disabledDates;
    return !(!t3 || !t3.to) && N(t3.to) > 10 * Math.floor(N(e2.pageDate) / 10) - 1;
  }
  function i() {
    var t3 = e2.disabledDates;
    return !(!t3 || !t3.from) && N(t3.from) <= 10 * Math.ceil(N(e2.pageDate) / 10);
  }
  function o(t3) {
    var a3 = false;
    return !(void 0 === e2.disabledDates || !e2.disabledDates) && (void 0 !== e2.disabledDates.to && e2.disabledDates.to && N(t3) < N(e2.disabledDates.to) && (a3 = true), void 0 !== e2.disabledDates.from && e2.disabledDates.from && N(t3) > N(e2.disabledDates.from) && (a3 = true), "function" == typeof e2.disabledDates.customPredictor && (a3 = e2.disabledDates.customPredictor(t3)), a3);
  }
  var l = computed(function() {
    for (var t3, a3, n3 = e2.pageDate, r3 = [], i2 = e2.useUtc ? new Date(Date.UTC(10 * Math.floor(n3.getUTCFullYear() / 10), n3.getUTCMonth(), n3.getUTCDate())) : new Date(10 * Math.floor(n3.getFullYear() / 10), n3.getMonth(), n3.getDate(), n3.getHours(), n3.getMinutes()), l2 = 0; l2 < 10; l2 += 1)
      r3.push({ year: N(i2), timestamp: i2.getTime(), isSelected: (t3 = i2, a3 = void 0, a3 = R(e2.selectedDate), !!e2.selectedDate && N(a3) === N(t3)), isDisabled: o(i2) }), Y(i2, N(i2) + 1);
    return r3;
  }), s = computed(function() {
    var t3 = 10 * Math.floor(N(e2.pageDate) / 10), a3 = t3 + 9, n3 = e2.translation && e2.translation.yearSuffix;
...
var pe = { af: (ue = "Afrikaans", ce = ["So.", "Ma.", "Di.", "Wo.", "Do.", "Vr.", "Sa."], { months: ["Januarie", "Februarie", "Maart", "April", "Mei", "Junie", "Julie", "Augustus", "September", "Oktober", "November", "Desember"], monthsAbbr: ["Jan", "Feb", "Mrt", "Apr", "Mei", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Des"], days: ce, yearSuffix: "", ymd: false, rtl: false, language: ue, langName: ue, daysNames: ce }), hi: function() {
  ...
  var e2 = "Fran\xE7ais";
  return { months: ["Janvier", "F\xE9vrier", "Mars", "Avril", "Mai", "Juin", "Juillet", "Ao\xFBt", "Septembre", "Octobre", "Novembre", "D\xE9cembre"], monthsAbbr: ["Jan", "F\xE9v", "Mar", "Avr", "Mai", "Jui", "Juil", "Ao\xFB", "Sep", "Oct", "Nov", "D\xE9c"], days: ["Dim", "Lun", "Mar", "Mer", "Jeu", "Ven", "Sam"], language: e2, yearSuffix: "", ymd: false, rtl: false, langName: e2, daysNames: ["Dimanche", "Lundi", "Mardi", "Mercredi", "Jeudi", "Vendredi", "Samedi"] };
}(), nl: function() {
  ...
  var e2 = "Portugu\xEAs";
  return { months: ["Janeiro", "Fevereiro", "Mar\xE7o", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"], monthsAbbr: ["Jan", "Fev", "Mar", "Abr", "Mai", "Jun", "Jul", "Ago", "Set", "Out", "Nov", "Dez"], days: ["Dom", "Seg", "Ter", "Qua", "Qui", "Sex", "Sab"], language: e2, yearSuffix: "", ymd: false, rtl: false, langName: e2, daysNames: ["Domingo", "Segunda-Feira", "Ter\xE7a-Feira", "Quarta-Feira", "Quinta-Feira", "Sexta-Feira", "S\xE1bado"] };
}(), it: function() {
  var e2 = "Italian";
  return { months: ["Gennaio", "Febbraio", "Marzo", "Aprile", "Maggio", "Giugno", "Luglio", "Agosto", "Settembre", "Ottobre", "Novembre", "Dicembre"], monthsAbbr: ["Gen", "Feb", "Mar", "Apr", "Mag", "Giu", "Lug", "Ago", "Set", "Ott", "Nov", "Dic"], days: ["Dom", "Lun", "Mar", "Mer", "Gio", "Ven", "Sab"], language: e2, yearSuffix: "", ymd: false, rtl: false, langName: e2, daysNames: ["Domenica", "Luned\xEC", "Marted\xEC", "Mercoled\xEC", "Gioved", "Venerd\xEC", "Sabato"] };
}(), pl: function() {
  var e2 = "Polish";
  ...
  var e2 = "T\xFCrk\xE7e";
  return { months: ["Ocak", "\u015Eubat", "Mart", "Nisan", "May\u0131s", "Haziran", "Temmuz", "A\u011Fustos", "Eyl\xFCl", "Ekim", "Kas\u0131m", "Aral\u0131k"], monthsAbbr: ["Oca", "\u015Eub", "Mar", "Nis", " May", "Haz", "Tem", "A\u011Fu", "Eyl", "Eki", "Kas", "Ara"], days: ["Pzt", "Sal", "\xC7ar", "Per", "Cum", "Cmt", "Pzr"], language: e2, yearSuffix: "", ymd: false, rtl: false, langName: e2, daysNames: ["Pazartesi", "Sal\u0131", "\xC7ar\u015Famba", "Per\u015Fembe", "Cuma", "Cumartesi", "Pazar"] };
}() };
var me = defineComponent({ name: "Datepicker", components: { DateInput: J, PickerDay: Q, PickerMonth: te, PickerYear: ie }, directives: { clickoutside: x }, props: { modelValue: { type: [Date, String, Number] }, value: { type: [Date, String, Number] }, format: { type: [String, Function], default: "dd MMM yyyy" }, language: { type: String, default: "en" }, openDate: { validator: function(e2) {
  return function(e3) {
  ...
  var l = ref(false), s = ref(false), d = ref(false), u = ref(0), f = ref(new Date()), h = computed(function() {
    ...
    return { position: g.value ? "static" : void 0 };
  }), D = computed(function() {
    return l.value || s.value || d.value;
  }), w = computed(function() {
    return v.value && true === v.value.rtl;
  });
  function k(t3) {
    t3 || (t3 = e2.openDate ? new Date(e2.openDate) : new Date()), i.value = F(new Date(t3), 1);
  }
  function S(t3) {
  ...
  function C2(e3) {
    l.value = false, s.value = false, d.value = false, g.value || e3 && n2("closed");
  }
  function _2() {
  ...
  function V2(t3) {
    var a3 = new Date(t3);
    o.value = a3, k(a3), n2("selected", a3), e2.modelValue ? n2("update:modelValue", a3) : n2("input", a3);
  }
  function N2(e3) {
    V2(e3.timestamp), g.value || C2(true), f.value = new Date();
  }
  function T2(e3) {
    var t3 = e3;
  ...
  return watch(function() {
    ...
    j2();
  }), e2.value && T2(e2.value), g.value && j2(), { pageTimestamp: i, selectedDate: o, showDayView: l, showMonthView: s, showYearView: d, calendarHeight: u, resetTypedDate: f, pageDate: y, translation: v, calendarStyle: b, isOpen: D, isInline: g, isRtl: w, setTypedDate: function(e3) {
    V2(e3.getTime());
  }, handleChangedMonthFromDayPicker: function(e3) {
    k(e3), n2("changed-month", e3);
  }, selectYear: function(e3) {
    var t3 = new Date(e3.timestamp);
    S("month") ? (k(t3), x2()) : N2(e3), n2("changed-year", e3);
  }, selectMonth: function(e3) {
    var t3 = new Date(e3.timestamp);
    S("day") ? (k(t3), _2()) : N2(e3), n2("changed-month", e3);
    ...
    return !e2.disabled && !g.value && (D.value ? C2(true) : (j2(), true));
  }, close: C2, allowedToShowView: S, showYearCalendar: M2, showMonthCalendar: x2, setPageDate: k, selectDate: N2, closeOnClickOutside: function() {
    C2();
  }, showDayCalendar: _2, computedInitialView: h, setDate: F, setDate1: V2, setValue: T2 };
} });
!function(e2, t2) {
  void 0 === t2 && (t2 = {});
  var a2 = t2.insertAt;
