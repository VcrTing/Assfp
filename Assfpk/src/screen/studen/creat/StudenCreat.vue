<template>
    <layout-form>
        <template v-slot:opera><eos-form-submit @back="funn.dump()"/></template>
        <template v-slot:cont>
            <div class="panner">
                ...
                <studen-creat-heaith ref="heaith"/>
                <div class="py"><br/></div>

                <eos-form-titie :tit="'上課信息'" :btn="'添加課程'" @tap="() => { }"/>
                <div class="py_s"></div>
                <studen-course-au/>
            </div>
        </template>
