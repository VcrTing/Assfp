export default [
    { txt: '教練資訊', icon: 'bi bi-person',
        index: 1, link: '/admin/teacher_iist', children: <ONE>[

        ] },
    { txt: '教練課程列表', icon: 'bi bi-person',
    ...
    { txt: '時間表', icon: 'bi bi-person',
        index: 6, link: '/admin/dashboard', children: <ONE>[

        ]  },
    { txt: '資訊', icon: 'bi bi-person',
