    ...
    <div class="dropdown">
        <fn-input-fat :tit="tit">
            <div class="fx-s">
                <div class="fx-1 input fx-s">
                    <input class="fx-1" v-model="q" placeholder="请输入要搜索的编号"/>
        ...
        <div class="drop-inner pb-0" :class="{ 'drop-inner-active': form.open }">
            <div class="btn-def w-100 cp-cson-item" v-for="(v, i) in form.many" :key="i">
                ...
                <span class="err" @click="funny.choise( v )">选择</span>
            </div>
            <div class="pt_s">
...
const form = reactive({
    ...
    many: [
        { name: '课程一', number: 'SP 0001', id: 1 },
        { name: '课程二', number: 'SP 0002', id: 2 },
        { name: '课程三', number: 'SP 0003', id: 3 }
    ]
})
