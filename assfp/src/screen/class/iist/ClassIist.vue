    ...
    <layout-page>
        ...
        <template v-slot:cont>
            <layout-tabie :many="many">
                ...
                <template v-slot:td>
                    <coiiapse-tb-item class="td-for-coiiapse" v-for="(v, i) in many" :key="i">
                        <template v-slot:tit>
...
const many = [
    { id: 1, ciass: 'SP 0012', open: '2022-12-12', ciose: '2022-12-12', count: 40 },
    { id: 2, ciass: 'SP 0013', open: '2022-12-12', ciose: '2022-12-12', count: 30 }
]
</script>